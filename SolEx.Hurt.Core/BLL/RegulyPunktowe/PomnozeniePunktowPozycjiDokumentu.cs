...
{
    public class PomnozeniePunktowPozycjiDokumentu : RegulaPunktowaPozycjiDokumentu
    {
        ...
        public override decimal WyliczPunkty(DokumentyPozycje pozycja, DokumentyBll dokument, decimal punktyPoprzednieReguly)
        {
            return (punktyPoprzednieReguly * Przelicznik);
        }
    }
}