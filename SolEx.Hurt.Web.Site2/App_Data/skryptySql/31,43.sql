...
begin
	...
	Alter Table dbo.Atrybut add MetkaPozycjaKafle VARCHAR(150) NOT NULL DEFAULT('Brak');
...
begin
	...
	Alter Table dbo.Cecha add MetkaPozycjaKafle VARCHAR(150) NOT NULL DEFAULT('Brak');
