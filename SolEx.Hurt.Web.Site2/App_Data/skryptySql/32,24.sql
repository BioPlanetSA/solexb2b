...
SET @tblName = 'Produkt'
SET @colname = 'DaneDlaProduktowWirtualnych'
SET @dbType = 'nvarchar(max) NULL' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
