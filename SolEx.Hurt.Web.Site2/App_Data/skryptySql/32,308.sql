...
SET @tblName = 'Atrybut'
SET @colname = 'UniwersalnaMetkaKatalog'
SET @dbType = 'nvarchar(2000) NULL' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
