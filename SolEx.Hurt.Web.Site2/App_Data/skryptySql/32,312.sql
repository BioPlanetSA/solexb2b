...
SET @tblName = 'Koszyk'
SET @colname = 'Uwagi'
SET @dbType = 'nvarchar(1000) NULL' --PAMIĘTAJ DODAĆ INFORMACJHE CZY MA BYĆ NULL LUB NOT NULL --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))
