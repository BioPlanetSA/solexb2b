...
SET @newColname = 'DokumentID'

if exists (select column_name from INFORMATION_SCHEMA.columns where table_name = @tblName and column_name = 'ZamowienieId') 
begin
	...
	EXEC sp_rename 'ZamowienieProdukt.ZamowienieId', @newColname;
