...
SET @tblName = 'Jednostka'
SET @colname = 'Zaokraglenie'
SET @dbType = 'int not null  DEFAULT ((2)) ' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
...
SET @colname = 'Ilosc'
SET @dbType = 'decimal(16, 6) NOT NULL'
