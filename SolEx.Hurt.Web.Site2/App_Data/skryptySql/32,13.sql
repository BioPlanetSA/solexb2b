...
SET @colname = 'Dwustronny'
SET @dbType = 'bit NOT NULL DEFAULT (1) ' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
