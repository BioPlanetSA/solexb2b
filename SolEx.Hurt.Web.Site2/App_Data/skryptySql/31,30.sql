...
SET @colname = 'IloscProduktu'
SET @dbType = 'decimal(10,2) NOT NULL DEFAULT ((  0.0  ))'
...
SET @colname = 'WarunekIlosci'
SET @dbType = 'varchar(50) NOT NULL DEFAULT ((  0.0  ))'
if not exists (select column_name from INFORMATION_SCHEMA.columns where table_name = @tblName and column_name = @colname) 
begin
...
SET @colname = 'WarunekIlosciMinimalnej'
