...
-- ustawienie PLN - chyba wszedzie jest taka waluta?
  update Klient set WalutaId = 8760005844606919495 where WalutaId is null;
  update Klient set WalutaId = 8760005844606919495 where WalutaId not in (select id from Waluta);
