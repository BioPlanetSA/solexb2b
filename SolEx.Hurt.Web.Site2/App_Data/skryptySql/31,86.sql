...
SET @tblName = 'Produkt'
SET @colname = 'Abstrakcyjny'
SET @dbType = 'bit NOT NULL DEFAULT (0)' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
