...
SET @colname = 'Kolejnosc'
SET @dbType = 'int NOT NULL Default(0)' --jesli ma byc wartość domyslna do dopisujemy:  DEFAULT ((  tu wartosc domyslna  ))  np. bit NOT NULL DEFAULT (1)
