...
SET @colname = 'FolderDoGaleriiZdjec2'
...
SET @colname = 'FolderDoGaleriiZdjec3'
...
if exists (select column_name from INFORMATION_SCHEMA.columns where table_name = @tblName and column_name = 'FolderZdjecDoGalerii') 
BEGIN
	----- Zmiana nazwy kolumny
	EXEC sp_rename 'BlogWpis.FolderZdjecDoGalerii', 'FolderDoGaleriiZdjec1';
END;
