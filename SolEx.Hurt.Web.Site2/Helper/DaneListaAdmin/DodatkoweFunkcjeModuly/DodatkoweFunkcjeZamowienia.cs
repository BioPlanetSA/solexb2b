...
{
    public class DodatkoweFunkcjeZamowienia : DodatkoweFunkcjeBaza
    {
        public override Type OblugiwanyTyp()
        {
            return typeof(ZamowieniaBLL);
        }

        public override IList<DodatkowaFunkcja> PobierzDodatkoweFunkcjeDlaObiektu(object o)
        {
            ZamowieniaBLL obiekt = (ZamowieniaBLL)o;
            List<DodatkowaFunkcja> wynik = new List<DodatkowaFunkcja>();
            
            wynik.Add(new DodatkowaFunkcja { Adres = "Zamowienie/" + obiekt.Id, Nazwa = "Edytuj" });
            return wynik;
        }
