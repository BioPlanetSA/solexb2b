...
namespace SolEx.Hurt.Web.Site2
{
    public static class RouteCollectionExtensions
    {
        ...
        public static void MapMvcAttributeRoutes(this RouteCollection routeCollection, Assembly controllerAssembly)
        {
            ...
            var attributeRoutingMapperType = attributeRoutingAssembly.GetType("System.Web.Mvc.Routing.AttributeRoutingMapper");

            MethodInfo mapAttributeRoutesMethod = attributeRoutingMapperType.GetMethod(
                "MapAttributeRoutes",
        ...
        public static void MapLocalizedMvcAttributeRoutes(this RouteCollection routes, string urlPrefix, RouteValueDictionary defaults, RouteValueDictionary constraints)
        {
            ...
            {
                MapMvcAttributeRoutes(localizedRouteTable, typeof(AdminController).Assembly);
            }
