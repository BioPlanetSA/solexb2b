var CookieAlert = {
	...
	init : function(options) {
		...
		window.onload = function() {
			...
			var content = CA.options.text + '<img src="/layout/images/cookie/' + CA.options.style + '/close.png" id="CookieAlertClose" style="border:0;position:absolute;top:9px;right:30px;cursor:pointer;" title="'+CA.options.close+'"/>';
