...
namespace SolEx.Hurt.Sync.App.Modules_.NoweModuly.Klienci
{
    public class PrzeliczenieIlosci : SyncModul, IModulKlienci
    {
        ...
        public void Przetworz(ref Dictionary<int, klienci> listaWejsciowa, Dictionary<int, produkty> produktyB2B, ref List<KupowaneIlosci> ilosci, ref List<Adresy> adresyWErp, List<kategorie_klientow> kategorie, List<klienci_kategorie> laczniki, ref List<sklepy> sklepy, ref List<sklepy_kategorie_polaczenia> sklpeylaczniki, ref List<sklepy_kategorie> sklepyKategorie)
        {
