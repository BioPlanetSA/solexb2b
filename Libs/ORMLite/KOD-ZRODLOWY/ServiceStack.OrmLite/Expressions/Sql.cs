...
namespace ServiceStack.OrmLite
{
	public static class Sql
	{
        ...
        public static bool InSubquery<T, TT>(T value, SqlExpressionVisitor<TT> podzapytanie)
        {
            return false;
        }

        public static bool NotInSubquery<T, TT>(T value, SqlExpressionVisitor<TT> podzapytanie)
        {
            return false;
        }
