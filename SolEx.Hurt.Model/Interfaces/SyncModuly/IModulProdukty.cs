...
{
    [SyncJakaOperacja(Enums.ElementySynchronizacji.Produkty)]
    public interface IModulProdukty
    {
        void Przetworz(ref List<Produkt> listaWejsciowa, ref List<Tlumaczenie> produktyTlumaczenia, Dictionary<long, Produkt> produktyNaB2B,
