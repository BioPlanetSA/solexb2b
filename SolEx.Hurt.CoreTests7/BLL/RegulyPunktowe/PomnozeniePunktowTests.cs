...
{
    public class PomnozeniePunktowTests
    {
        [Fact(DisplayName = "Mnożenie punktów za dokument")]
        ...
        {
            PomnozeniePunktow mod=new PomnozeniePunktow();
            IDokument dok = A.Fake<IDokument>();

            mod.Przelicznik = przelicznik;
            decimal wynik = mod.WyliczPunkty(dok, wejsciowe);
