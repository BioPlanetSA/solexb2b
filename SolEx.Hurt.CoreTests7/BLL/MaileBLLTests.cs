...
namespace SolEx.Hurt.CoreTests.BLL
{
    ...
    {
        [Fact(DisplayName = "Sprawdza czy poprawnie przetwarza lnki w treści maili")]
        public void PrzetworzLinkiWTresciMailaTest()
        {
            ...
            string testMessage = "<a href=\"/produkty\">produkty</a> <img src=\"../zasoby/costam\"><img src=\"/zasoby/costam\">";
            string wynik = maile.PrzetworzLinkiWTresciMaila(testMessage);
            Assert.True(wynik.Contains("\"http://localhost/produkty"));
            Assert.True(wynik.Contains("\"http://localhost/Zasoby/costam"));
